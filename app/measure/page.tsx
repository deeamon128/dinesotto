    ...
    <main className="bg-ivory min-h-screen">
      <div className="bg-green-900 pt-32 pb-16 px-8 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-xl mx-auto text-center">
          <p className="font-sans text-[0.65rem] tracking-[0.2em] uppercase text-green-300/80 mb-4">
            In the restaurant?
          </p>
          <h1 className="font-display text-5xl font-light italic text-green-100 leading-[1.1] mb-4">
            Measure the noise level.
          </h1>
          <p className="font-sans font-light text-green-300/80 text-sm leading-relaxed">
